...
from app.PyPSI.psi.protocol.rsa.client import Client
from app.PyPSI.psi.protocol.rsa.server import Server
...
def from_private(private_key):
    ...
    Returns:
        tuple of public and private RSA keys.
    """
    public_key = RSA.construct((private_key.n, private_key.e, private_key.d), True)
