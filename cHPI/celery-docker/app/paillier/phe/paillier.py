...
from app.paillier.phe.util import invert, powmod, getprimeover, isqrt
...
##
## Made changes (1 line):
##  Increase maximum value that may be stored
##
########################################################################
    def __init__(self, n):
        self.g = n + 1
